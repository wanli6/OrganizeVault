...
The final product may be delivered as an Obsidian plugin, a Claude skill, or a combination of both.
...
To install the skill so Claude Code can discover and invoke it:
